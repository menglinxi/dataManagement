    ...
    <section>
        ...
        <el-table :data="pager.dataList" border stripe style="width: 100%">
            ...
            <el-table-column label="操作" show-overflow-tooltip header-align="center" align="center">
                <template slot-scope="scope">
                    <el-button-group>
                        <el-button title="编辑权限" v-if="!scope.row.installed" size="mini" type="primary"
        ...
        <el-dialog :title="Permission.id == 0 ? '添加权限' : '编辑权限' " :visible.sync="addEditShow" width="30%">
            <el-form :model="Permission" :rules="$rules" ref="PermissionForm">
                <el-form-item label="名称" :label-width="formLabelWidth" prop="name">
                    <el-input v-model="Permission.name" auto-complete="off" placeholder="请填写权限名称"
                              suffix-icon="el-icon-fa-vcard"></el-input>
                </el-form-item>
                <el-form-item label="描述" :label-width="formLabelWidth" prop="description">
                    <el-input type="textarea" :maxlength="500"
                              :autosize="{ minRows: 4, maxRows: 8}" v-model="Permission.description" auto-complete="off"
                              placeholder="请填写权限描述" suffix-icon="el-icon-fa-file-word-o"></el-input>
                </el-form-item>
            </el-form>
